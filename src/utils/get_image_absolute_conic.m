function image_absolute_conic = get_image_absolute_conic(l_infs, vps, vp1s, vp2s, H)
    ...
    % 
    % input
    % l_infs: image of the line at the infinite (SET OF LINES)
    % vps: vertical vanishing point (SET)
